...
if($getMode == 'start' || $getMode == 'anlegen')     //Default: start
{
        ...
        || (!isset($arr['IST']['TBL_USER_FIELDS']['Mandatsdatum']['usf_name'])))
    {
        ...
        $form->addButton('btnAnlegen', $gL10n->get('SYS_NEXT'), array('icon' => 'bi-arrow-right-circle-fill', 'link' => SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER .'/system/installation.php', array('mode' => 'anlegen')), 'class' => 'btn-primary'));
    ...
    else
    {
        ...
        $form->addButton('btnSollIst', $gL10n->get('SYS_NEXT'), array('icon' => 'bi-arrow-right-circle-fill', 'link' => SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER .'/system/installation.php', array('mode' => 'soll_ist')), 'class' => 'btn-primary'));
