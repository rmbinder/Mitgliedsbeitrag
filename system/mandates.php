...
else
{
    ...
    $javascriptCode = '
        ...
        $("input[type=checkbox].change_checkbox").click(function(){
            var datum = $("#datum").val();
            $.post("'. SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER .'/system/mandates.php', array('mode' => 'assign')) .'&datum_neu=" + datum,
                function(data){
        ...
        $("input[type=checkbox].memlist_checkbox").click(function(e){
            ...
            $.post("'. SecurityUtils::encodeUrl(ADMIDIO_URL . FOLDER_PLUGINS . PLUGIN_FOLDER .'/system/mandates.php', array( 'mode' => 'assign')) .'&datum_neu=" + datum + "&usr_id=" + userid,
                function(data){
                    // check if error occurs
                    if(data == "success") {
                        if(member_checked){
