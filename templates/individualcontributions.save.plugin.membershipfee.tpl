<div class="table-responsive">     
    <table id="table_save_individualcontributions" class="{$classTable}" {foreach $attributes as $attribute} {$attribute@key}="{$attribute}" {/foreach}style="max-width: 100%;">
        <thead>
            <tr>
    ...
    <p>{$l10n->get('PLG_MEMBERSHIPFEE_INDIVIDUAL_CONTRIBUTIONS_SAVED')}</p>        
</div>   
