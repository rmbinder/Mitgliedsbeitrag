<div class="table-responsive">     
    <table id="table_save_recalculation" class="{$classTable}" {foreach $attributes as $attribute} {$attribute@key}="{$attribute}" {/foreach}style="max-width: 100%;">
        <thead>
            <tr>
    ...
    <p>{$l10n->get('PLG_MEMBERSHIPFEE_RECALCULATION_SAVED')}</p>        
</div>   
