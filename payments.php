...
else
{
    ...
    $membersListFields = array_filter($pPreferences->config['columnconfig']['payments_fields']);            //array_filter: l�schen leerer Eintr�ge, falls das Setup fehlgeschlagen ist 
